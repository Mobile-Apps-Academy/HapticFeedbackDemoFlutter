...
A demo of haptic feedback, Developed using Flutter and haptic-feedback package.
...
git clone https://github.com/Mobile-Apps-Academy/HapticFeedbackDemoFlutter.git

```
### Usage

1. Add the haptic feedback package
...
2. How to add the feedback on button click
